...
$db['apps']=array (
  ...
  array (
    ...
    'webpath'=>array('type'=>'varchar(20)', 'comment' => app::get('base')->_('远程地址')),
    ...
    'author_name'=>array('type'=>'varchar(100)','comment' => app::get('base')->_('作者名')),
    'author_url'=>array('type'=>'varchar(100)','comment' => app::get('base')->_('作者url')),
    'author_email'=>array('type'=>'varchar(100)','comment' => app::get('base')->_('作者邮件')),
    'dbver'=>array('type'=>'varchar(32)','comment' => app::get('base')->_('目前安装版本')),
    'remote_config'=>array('type'=>'serialize','comment' => app::get('base')->_('远程配置信息')),
  ),
  'version' => '$Rev: 44008 $',
  'unbackup' => true,
