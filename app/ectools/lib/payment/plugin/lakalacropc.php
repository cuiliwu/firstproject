<?php
final class ectools_payment_plugin_lakalacropc extends ectools_payment_app implements ectools_interface_payment_app {

	/**
	 * @var string 支付方式名称
	 */
    public $name = '拉卡拉境外支付(pc)';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = 'lakalacropc';
     /**
     * @var string 支付方式key
     */
    public $app_key = 'lakalacropc';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'lakalacropc';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '拉卡拉境外支付(pc)';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'USD';
    ...
    public $sdk_front_trans_url = 'https://intl.lakala.com:7777/ppayGate/CrossBorderWebPay.do';
    ...
    public function __construct($app){
		...
		$this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_lakalacropc_server', 'callback');
		...
		$this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_lakalacropc', 'callback');
