...
final class ectools_payment_plugin_99bill extends ectools_payment_app {
    ...
    function admin_intro(){
        return app::get('ectools')->_('ecclub联合快钱推出：免费签约，1%优惠费率，更有超值优惠的信用卡支付。<bR>快钱是国内领先的独立第三方支付企业，旨在为各类企业及个人提供安全、便捷和保密的支付清算与账务服务，其推出的支付产品包括但不限于人民币支付，外卡支付，神州行卡支付，联通充值卡支付，VPOS支付等众多支付产品, 支持互联网、手机、电话和POS等多种终端, 以满足各类企业和个人的不同支付需求。截至2009年6月30日，快钱已拥有4100万注册用户和逾31万商业合作伙伴，并荣获中国信息安全产品测评认证中心颁发的“支付清算系统安全技术保障级一级”认证证书和国际PCI安全认证。');
    }
    ...
    function gen_form(){
          ...
          $tmp_form='<a href="http://service.ecclub.cn/checkcert.php?pay_id=2&certi_id='.$certid.'&url='.$url.'
" target="_blank"><img src="'.$this->app->base_url().'plugins/payment/images/99bill_apply.gif"></a>&nbsp;&nbsp;&nbsp;<font color="green">'.app::get('ectools')->_('绿卡用户申请快钱支付，费率更低，').'</font><a href="http://www.ecclub.cn/ecclub_price/sq/index.html" target="_blank"><font color="green">'.app::get('ectools')->_('点击了解绿卡').'</font></a>';
