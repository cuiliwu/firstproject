...
class dbeav_model extends base_db_model{
    ...
    function save(&$data,$mustUpdate = null, $mustInsert=false){
        ...
        if(!$this->db_save($plainData,($mustUpdate?$this->sdf_to_plain($mustUpdate):null),$mustInsert )) return false;
    ...
    function _save_parent( &$data,$mustUpdate, $mustInsert=false ){
    ...
    function _save_depends(&$data,$mustUpdate = null, $mustInsert=false){
