...
class weixin_qrcode_QRcode {
    ...
    //----------------------------------------------------------------------
    public function encodeInput(weixin_qrcode_QRinput $input)
    {
    ...
    public function encodeString8bit($string, $version, $level)
    {
        ...
        $input = new weixin_qrcode_QRinput($version, $level);
    ...
    public function encodeString($string, $version, $level, $hint, $casesensitive)
    {
        ...
        $ret = weixin_qrcode_QRsplit::splitStringToQRinput($string, $input, $hint, $casesensitive);
        if($ret < 0) {
            return NULL;
        }
    ...
    {
        $enc = weixin_qrcode_QRencode::factory($level, $size, $margin);
