...
class desktop_ctl_default extends desktop_controller{
    ...
    function index(){
        ...
        */
        ...
        $this->pagedata['desktop_menu'] = (count($desktop_menu)) ? ''.join('', $desktop_menu).'' : '';
        ...
        $this->pagedata['certificate_url'] = "http://key-service.ecclub.cn/index.php?sess_id=".urlencode($this->pagedata['session_id'])."&certi_id=".urlencode($this->Certi)."&version=ecstore&confirmkey=".urlencode($confirmkey)."&_key_=do";
