...
class site_ctl_admin_explorer_theme extends site_admin_controller
{
    ...
    {
        return kernel::single('site_theme_file')->get_theme_dir($theme, $open_path);
    }//End Function
    ...
    public function detail()
    {
        ...
        $get_file = kernel::single('site_theme_file')->get_file($dir, $file_name);
        ...
        if(in_array($filenameInfo['extension'], array('css', 'html', 'js', 'xml'))){
            if($filenameInfo['extension'] == 'css'){
                $file_content = kernel::single('site_theme_file')->get_content($file_content);
            }
            ...
            $this->pagedata['file_url'] = kernel::single('site_theme_file')->get_full_file_url($theme, $file_content, $open_path, $file_name);
    ...
    public function save_image()
    {
        ...
        $file_name = kernel::single('site_theme_file')->get_file($dir, $file_name);
