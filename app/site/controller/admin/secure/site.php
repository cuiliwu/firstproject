...
class site_ctl_admin_secure_site extends desktop_controller
{
    public function index()
    {
        ...
        $this->pagedata['anti_frame_script'] = app::get('site')->getConf('site.anti_frame_script.enable');
    ...
    public function save()
    {
        ...
        if(isset($params['anti_frame_script']) && $params['anti_frame_script'])
        {
            app::get('site')->setConf('site.anti_frame_script.enable', true);
        }else{
            app::get('site')->setConf('site.anti_frame_script.enable', false);
        }
