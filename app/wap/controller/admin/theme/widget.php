...
class wap_ctl_admin_theme_widget extends desktop_controller
{
    ...
    function __construct($app)
    {
        $request_params = array(
            ...
            'widgets_app' => $_GET['widgets_app'],
            'widgets_theme' => $_GET['widgets_theme'],
            'widgets_id' => $_GET['widgets_id'],
            'domid' => $_GET['domid'],
            'post_catalog' => $_POST['catalog'],
            'post_wg' => $_POST['__wg'],
            'post_widgets' => $_POST['widgets'],
            'post_html' => $_POST['html'],
            'post_files' => $_POST['files'],
        );
