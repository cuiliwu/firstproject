    ...
    public function file_list($filter){
        ...
        if(!isset($this->_cacheList[$key])){
            ...
            $ftype = array(
                    ...
                    'ttf'=>app::get('site')->_('字体文件'),
                    'svg'=>app::get('site')->_('字体文件'),
                    'woff'=>app::get('site')->_('字体文件'),
                    'eot'=>app::get('site')->_('字体文件'),
                );
    ...
    public function is_dir_writable($dir) 
    {
        ...
        if($handle = @fopen($file, 'a+')){
            if(@fwrite($handle, 'test version')){
                ...
                trigger_error(app::get('wap')->_('目标目录不可写'), E_USER_ERROR);
                return false;
            }
        }else{
            trigger_error(app::get('wap')->_('目标目录不可写'), E_USER_ERROR);
