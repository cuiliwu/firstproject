...
class wap_trustlogin_qq
{
    ...
    {
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/wap_trustlogin_qq', 'callback');
    ...
    public function get_logo()
    {
        ...
        $data['image'] = $this->app->res_url.'/trustlogin/qqlogin.png';
        $data['url'] = $this->dialog_url.'?response_type=code&client_id='.$this->get_appkey()."&redirect_uri=" . urlencode($this->my_url) . "&state=". $_SESSION['qqst'];
