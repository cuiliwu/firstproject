...
class wap_trustlogin_kaixin
{
    ...
    {
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/' . $this->app->app_id . '/wap_trustlogin_kaixin', 'callback');
    ...
    public function get_logo()
    {
        ...
        $data['image'] = $this->app->res_url.'/trustlogin/kaixin.png';
