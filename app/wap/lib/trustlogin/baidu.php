...
class wap_trustlogin_baidu
{
    ...
    {
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/' . $this->app->app_id . '/wap_trustlogin_baidu', 'callback');
    ...
    {
        $data = app::get('trustlogin')->getConf('trustlogin_plugin_baidu');
        return $data['appKey'];
    }
    //获取appSecret
    ...
    public function get_logo()
    {
        ...
        $status = app::get('trustlogin')->getConf('trustlogin_plugin_baidu');
        $data['status'] = $status['status'];
        $data['image'] = $this->app->res_url.'/trustlogin/baidu.png';
