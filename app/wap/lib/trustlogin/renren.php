...
class wap_trustlogin_renren
{
    ...
    public function __construct($app)
    {
        ...
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/' . $this->app->app_id . '/wap_trustlogin_renren', 'callback');
    ...
    public function get_logo()
    {
        ...
        $data['image'] = $this->app->res_url.'/trustlogin/renren.png';
