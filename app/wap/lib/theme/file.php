...
class wap_theme_file
{

    function __construct(){
        if(ECAE_MODE==true){
            $this->fileObj = kernel::single('wap_theme_file_dbfile');
        }else{
            $this->fileObj = kernel::single('wap_theme_file_fsfile');
        }
    }
    ...
    {
        return $this->fileObj->delete_file($theme,$file);
    }//End Function
