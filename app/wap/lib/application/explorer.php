...
class wap_application_explorer extends base_application_prototype_xml 
{
    var $xml='wap.xml';
    var $xsd='wap_content';
    var $path = 'explorer';
    ...
    {
        return app::get('wap')->model('explorers')->insert($data);
    }//End Function
    ...
    function clear_by_app($app_id){
        ...
        app::get('wap')->model('explorers')->delete(array(
            'app'=>$app_id));
    }
