<?php
final class wap_payment_plugin_lakalacrowap extends ectools_payment_app implements ectools_interface_payment_app {

	/**
	 * @var string 支付方式名称
	 */
    public $name = '拉卡拉境外支付(wap)';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = 'lakalacrowap';
     /**
     * @var string 支付方式key
     */
    public $app_key = 'lakalacrowap';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'lakalacrowap';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '拉卡拉境外支付(wap)';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'USD';
    ...
    public function __construct($app){
		...
		$this->notify_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_lakalacrowap_server', 'callback');
		...
		$this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_lakalacrowap', 'callback');
